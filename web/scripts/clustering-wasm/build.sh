...
"$emcc_bin" \
  ...
  "$script_dir/umap_fuzzy_graph.cpp" \
  "$script_dir/umap_neighbors.cpp" \
  "$script_dir/umap_spectral.cpp" \
  -std=c++20 \
  -O3 \
  -msimd128 \
  --no-entry \
