...
- `test_audio.wav`: three final optimization runs completed in 12.402, 12.413,
  and 12.779 seconds (12.413-second median). The median run returned 7
  speakers/132 segments with 99.977% mapped agreement at 10 ms; clustering
  itself took 3.366 seconds.
